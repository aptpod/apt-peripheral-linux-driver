...
| bt_phase_seg2      | R    | ビットタイミング phase_seg2 |
| bt_sjw             | R    | ビットタイミング sjw |
| bt_brp             | R    | ビットタイミング brp |
| dbt_prop_seg       | R    | データフェーズビットタイミング prog_seg |
| dbt_phase_seg1     | R    | データフェーズビットタイミング phase_seg1 |
| dbt_phase_seg2     | R    | データフェーズビットタイミング phase_seg2 |
| dbt_sjw            | R    | データフェーズビットタイミング sjw |
| dbt_brp            | R    | データフェーズビットタイミング brp |
