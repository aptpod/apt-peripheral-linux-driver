/*
 * ep1_cf02a_set_rtc_time.c - Set RTC Time.
 *
...
#define PRGNAME "ep1_cf02a_set_rtc_time"
...
main(int argc, char* argv[])
{
    ...
    result = ioctl(fd, EP1_CF02A_IOCTL_SET_RTC_TIME);
    if (result == -1) {
        printf("ioctl().. Error, <errno:%d> cmd=%s\n", errno, "EP1_CF02A_IOCTL_SET_RTC_TIME");
        return EXIT_FAILURE;
    }
